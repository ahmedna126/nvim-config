return {
	...
	config = function()
		...
		vim.api.nvim_set_keymap("n", "g<c-z>", require("dial.map").inc_gnormal(), { noremap = true })
		vim.api.nvim_set_keymap("n", "g<c-x>", require("dial.map").dec_gnormal(), { noremap = true })
		vim.api.nvim_set_keymap("v", "<c-z>", require("dial.map").inc_visual() .. "gv", { noremap = true })
		vim.api.nvim_set_keymap("v", "<c-x>", require("dial.map").dec_visual() .. "gv", { noremap = true })
		vim.api.nvim_set_keymap("v", "g<c-z>", require("dial.map").inc_gvisual() .. "gv", { noremap = true })
